...
public final class CustomerId extends AggregateRootUuid {
    ...
    public static @interface CustomerIdStr {
        ...
        default "{org.fuin.cqrs4j.example.shared.CustomerId.message}";
     ...
     */
    public static final class Converter implements ValueObjectConverter<UUID, CustomerId>, JsonbAdapter<CustomerId, UUID> {
