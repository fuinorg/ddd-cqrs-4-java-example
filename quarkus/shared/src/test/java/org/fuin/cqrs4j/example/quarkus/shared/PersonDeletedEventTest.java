...
public final class PersonDeletedEventTest {
    ...
    public final void testSerializeDeserialize() {
        ...
        // PREPARE
        final org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent original = createTestee();

        // TEST
        final org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent copy = deserialize(serialize(original));
    ...
    public final void testMarshalUnmarshalJson() throws Exception {
        ...
        try (final Jsonb jsonb = JsonbBuilder.create(config)) {
            ...
            // TEST
            final String json = jsonb.toJson(original, org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent.class);
            final org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent copy = jsonb.fromJson(json, org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent.class);
    ...
    public final void testToString() {
        final org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent testee = createTestee();
        assertThat(testee)
                .hasToString("Deleted person 'Peter Parker' (" + testee.getEntityId() + ") [Event " + testee.getEventId() + "]");
    }

    private org.fuin.cqrs4j.example.quarkus.shared.PersonDeletedEvent createTestee() {
