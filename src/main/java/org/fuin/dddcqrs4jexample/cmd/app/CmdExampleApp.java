...
import org.fuin.dddcqrs4jexample.cmd.domain.Person;
import org.fuin.dddcqrs4jexample.cmd.domain.PersonRepository;
import org.fuin.dddcqrs4jexample.cmd.domain.PersonRepositoryFactory;
...
public class CmdExampleApp {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            new LogbackStandalone().init(args, new NewLogConfigFileParams("org.fuin.dddcqrs4jexample", "logback"));
