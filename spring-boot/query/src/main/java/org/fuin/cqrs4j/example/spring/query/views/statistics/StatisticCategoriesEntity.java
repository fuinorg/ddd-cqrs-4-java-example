...
@NamedQuery(name = StatisticCategoriesEntity.FIND_ALL,
        query = "SELECT new org.fuin.cqrs4j.example.spring.query.views.statistics.CategoryStatistic(s.category, s.count) FROM StatisticCategoriesEntity s")
public class StatisticCategoriesEntity {
     ...
     *
     * @return Category statistic record.
     */
