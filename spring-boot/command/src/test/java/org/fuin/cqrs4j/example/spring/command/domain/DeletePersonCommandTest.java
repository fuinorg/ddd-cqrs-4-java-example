...
/**
 * Test for {@link DeletePersonCommand} class.
 */
class DeletePersonCommandTest {
    ...
    void testSerializeDeserialize() {
        ...
        assertThat(copy.getAggregateVersionInteger()).isZero();
    ...
    void testMarshalUnmarshalJson() throws Exception {
        ...
        final DeletePersonCommand copy = mapper.reader().readValue(json, DeletePersonCommand.class);
